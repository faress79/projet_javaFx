...
public class GestionReclamationController {
    ...
    public void addReclamationAction(ActionEvent actionEvent) {
        FXMLLoader fxmlLoader =new FXMLLoader(getClass().getResource("CreateOrEditReclamation.fxml"));
        Scene scene = null;
        try {
    ...
    private void showReclamationContent(Reclamation reclamation) {
        FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("GestionReponse.fxml"));
        Scene scene = null;
        try {
            scene = new Scene(fxmlLoader.load());
    ...
    public void openStats(ActionEvent actionEvent) {
        FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("ReclamationStats.fxml"));
        Scene scene;
        try {
            scene = new Scene(fxmlLoader.load());
            Stage stage = new Stage();
