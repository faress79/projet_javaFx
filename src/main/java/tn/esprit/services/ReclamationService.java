...
public class ReclamationService implements IReclamationService {
    ...
    public Reclamation getReclamationById(int id) {
        ...
        try {
            PreparedStatement statement = cnx.prepareStatement("SELECT * FROM reclamation WHERE id = ?");
    ...
    public int removeReclamation(int id) {
        int result = 0;
        try {
            PreparedStatement statement = cnx.prepareStatement("DELETE FROM reclamation WHERE id = ?");
            statement.setInt(1, id);
